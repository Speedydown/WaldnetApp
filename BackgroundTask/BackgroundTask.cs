...
namespace BackgroundTask
{
    public sealed class BackgroundTask : IBackgroundTask
    {
        ...
        {
            XmlDocument RectangleTile = TileXmlHandler.CreateRectangleTile(TileUpdateManager.GetTemplateContent(TileTemplateType.TileWide310x150IconWithBadgeAndText), Content, Counter, "ms-appx:///assets/PompeBledTransparnt.png", "Wâldnet.nl", "Wâldnet.nl");
            XmlDocument SquareTile = TileXmlHandler.CreateSquareTile(TileUpdateManager.GetTemplateContent(TileTemplateType.TileSquare150x150IconWithBadge), Content, "ms-appx:///assets/PompeBledTransparnt.png", "Wâldnet.nl", "Wâldnet.nl");
